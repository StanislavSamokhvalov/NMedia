...
class PostDaoImpl(private val db: SQLiteDatabase) : PostDao {
    companion object {
        ...
        CREATE TABLE ${PostColumns.TABLE} (
            ...
            ${PostColumns.COLUMN_VIDEO} TEXT NOT NULL DEFAULT DEFAULT ''
        );
        """.trimIndent()
    }
    object PostColumns {
    ...
    override fun save(post: Post): Post {
        val values = ContentValues().apply {
            ...
            put(PostColumns.COLUMN_SHARE, post.replyAmount)
    ...
    private fun map(cursor: Cursor): Post {
        with(cursor) {
            ...
            return Post(
                ...
                replyAmount = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_SHARE)),
